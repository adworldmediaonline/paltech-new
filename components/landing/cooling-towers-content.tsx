  ...
  const keyBenefits = [
    {
      ...
      description: "Established in 1986, Paltech™ has served over 11,000 clients across 46+ countries with proven expertise in cooling tower manufacturing."
    },
    {
