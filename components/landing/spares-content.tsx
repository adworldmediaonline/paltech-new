    ...
    <div className="space-y-12">
      ...
      <div className="space-y-4">
        ...
        <p className="text-lg sm:text-xl text-gray-600 leading-relaxed">
          Paltech™ Cooling Towers and Equipments Ltd. is one of India's most trusted manufacturers and exporters of <strong>Cooling Tower Spares, FRP Fans, and Industrial Cooling Components</strong>. With over 37 years of engineering excellence, Paltech™ designs and delivers precision-built components that enhance cooling performance, minimize downtime, and extend equipment life.
        </p>
