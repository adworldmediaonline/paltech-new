          ...
          <div className="space-y-6">
            <section className="space-y-3">
              ...
              <p className="text-muted-foreground">
                Paltech introduces high‑strength, corrosion‑resistant and feather‑light GRP deck panels with staircase platform ladder compatibility.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-5 space-y-2 marker:text-primary text-muted-foreground">
                <li>Cooling Tower Decking</li>
                <li>Odor Control Covers</li>
                <li>Roofing Walkways</li>
                <li>Temporary Flooring</li>
                <li>Scaffolding</li>
                <li>Cellular Wall Panels</li>
              </ul>
            </section>
            ...
            <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Share size, load class, and environment—get a tailored proposal.</p>
                </div>
