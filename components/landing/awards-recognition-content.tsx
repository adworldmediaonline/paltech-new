        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-white/90 leading-relaxed">
                With 39+ years of experience, 11,000+ installations worldwide, and 11,000+ satisfied clients across 46+ countries, we continue to set benchmarks in the industry.
              </p>
            </div>
          </div>
        </div>
