    ...
    <div className="space-y-12">
      ...
      <div className="space-y-4">
        ...
        <p className="text-base sm:text-lg text-gray-600">
          With over 37 years of manufacturing expertise, Paltech™ has become a trusted name in cooling tower components across India and over 30 export countries. Our drive shafts are built to perform efficiently under the toughest industrial conditions — from power plants to chemical and steel industries.
        </p>
      </div>
