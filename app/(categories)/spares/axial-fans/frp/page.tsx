import { FRPFansContent } from "@/components/landing/frp-fans-content";
...
import frpFans1 from '../../../../../public/categories/frp-fans-1.webp';
import frpFans2 from '../../../../../public/categories/frp-fans-2.webp';
import frpFans3 from '../../../../../public/categories/frp-fans-3.webp';
import frpFans4 from '../../../../../public/categories/frp-fans-4.webp';

const images = [frpFans1, frpFans2, frpFans3, frpFans4];
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: '/spares/axial-fans/frp',
  },
  keywords: [
      ...
      <CategoryHero images={images}>
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator className="text-white/70" />
            <BreadcrumbItem>
              <BreadcrumbPage className="text-white font-semibold">FRP</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </CategoryHero>
