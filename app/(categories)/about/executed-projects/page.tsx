...
export const metadata: Metadata = {
  ...
  description: "Showcasing executed cooling tower projects across industries & countries. 37+ years of expertise delivering high-quality, reliable industrial solutions.",
  keywords: [
    "Cooling Towers",
    "Industrial Projects",
    "Chilling Plants",
